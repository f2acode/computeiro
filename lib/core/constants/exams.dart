...
final Exam exam2018 = Exam(
  ...
  questions: <Question>[
    ...
    <p></p>
    ''', correctAnswer: 'B'),
    Question(text: r'''''', correctAnswer: 'E'),
    Question(text: r'''''', correctAnswer: 'E'),
    Question(text: r'''''', correctAnswer: 'B'),
    Question(text: r'''''', correctAnswer: 'C'),
    Question(text: r'''''', correctAnswer: 'A'),
    Question(text: r'''''', correctAnswer: 'B'),
    Question(text: r'''''', correctAnswer: 'B'),
    Question(text: r'''''', correctAnswer: 'B'),
    Question(text: r'''''', correctAnswer: 'C'),
    Question(text: r'''''', correctAnswer: 'D'),
    Question(text: r'''''', correctAnswer: 'C'),
    Question(text: r'''''', correctAnswer: 'C'),
    Question(text: r'''''', correctAnswer: 'D'),
    Question(text: r'''''', correctAnswer: 'D'),
