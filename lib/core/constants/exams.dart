...
final Exam exam2018 = Exam(
  ...
  questions: <Question>[
    ...
    // TODO(felipe): fix question
    Question(text: Uri.encodeComponent(r'''
    O vetor diretor de uma reta \(r\) é \(v = (-1, 2)\) e passa pelo ponto P(-5, 5). A outra reta \(s\) tem 
    pendente m=-2 e passa pelo ponto N(0, 5). Em relação à disposição das retas, elas:

    <p></p>
    '''), correctAnswer: 'B'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'E'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'E'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'B'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'C'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'A'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'B'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'B'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'B'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'C'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'D'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'C'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'C'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'D'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'D'),
    ...
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'A'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'D'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: '*'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'A'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'B'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'E'),
    Question(text: Uri.encodeComponent(r''''''), correctAnswer: 'C'),
